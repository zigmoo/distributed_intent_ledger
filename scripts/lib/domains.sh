...
_DOMAIN_REGISTRY="${DOMAIN_REGISTRY:-${BASE_DIL:-$HOME/Documents/dil_agentic_memory_0001}/_shared/_meta/domain_registry.json}"
_BASE_DIL="${BASE_DIL:-$HOME/Documents/dil_agentic_memory_0001}"
