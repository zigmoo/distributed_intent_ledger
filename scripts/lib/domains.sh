...
_DOMAIN_REGISTRY="${DOMAIN_REGISTRY:-${BASE_DIL:-/home/moo/Documents/dil_agentic_memory_0001}/_shared/_meta/domain_registry.json}"
_BASE_DIL="${BASE_DIL:-/home/moo/Documents/dil_agentic_memory_0001}"
