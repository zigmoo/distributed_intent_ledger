...
usage() {
  cat << 'USAGE'
Usage:
  create_task.sh --domain work --task-id WORK-11331 --title "..." --project "..." [options]
...
Work-only required:
  --task-id JIRA-KEY      Example: WORK-11331

Options:
  --subcategory TEXT
  --parent-task-id TEXT   Optional parent task id (DIL-1234 or WORK-12345)
  ...
  --base PATH             Default: $HOME/Documents/dil_agentic_memory_0001
  --dry-run
  -h, --help
USAGE
}
