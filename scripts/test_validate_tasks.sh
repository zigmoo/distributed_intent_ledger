...
Options:
  --base PATH        Base path for agentic_memory (default: $HOME/Documents/dil_agentic_memory_0001)
...
write_task "WORK-5555" personal todo normal feature kanban high
# Move it to work/
mv "$TEST_BASE/_shared/tasks/personal/WORK-5555.md" "$TEST_BASE/_shared/tasks/work/WORK-5555.md"
write_index_header
write_counter 1100
write_changelog_header
