#!/usr/bin/env bash
# whats_hot_tool — Deterministic _hot.md prepend-only manager with sentinel separation and indexed retrieval
set -euo pipefail
...
exec "$PYTHON_PATH" "$SCRIPT_DIR/whats_hot_tool.py" --base "$BASE" "$@"
