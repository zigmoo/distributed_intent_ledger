...
# mirror: /az/talend/scripts/bin/url_tool (work-domain symlink)
#
...
#   See DMDI-12050 and DMDI-12011 for design details.
#
# Exit codes:
#   0  Success
#   1  General error
...
#   2. /az/talend/data/url_tool/domain_registry.json (scripts library — works on remote servers)
