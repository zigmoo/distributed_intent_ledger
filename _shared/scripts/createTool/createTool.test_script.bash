#!/usr/bin/env bash
# createTool.test_script.bash — golden file diff test suite for createTool
...
TEST_SCRIPT_NAME="createTool.test_script"
GOLDEN_DIR="$SCRIPT_DIR/createTool.test_golden"
