# script_forge_qc j2_templates

This drawer contains presentation templates owned by `script_forge_qc`.
...
Keep shared rendering engines, linkifiers, and nozzles in `_shared/scripts/lib/`. The tool owns the template; shared libraries own reusable rendering mechanics.
