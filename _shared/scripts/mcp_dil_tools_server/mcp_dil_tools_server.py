...
TOOLS: list[dict[str, Any]] = [
    ...
    {
        "name": "task_search",
        "description": "Search DIL tasks through task_tool search.",
        "inputSchema": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "task_review",
        "description": "Show full details for one DIL task through task_tool review.",
        "inputSchema": {
            "type": "object",
            "properties": {"task_id": _text_schema("Task id such as DIL-1452 or WORK-12007.")},
            "required": ["task_id"],
            "additionalProperties": False,
        },
    },
    ...
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {"ticket_id": _text_schema("Remote ticket id such as WORK-12007.")},
            "required": ["ticket_id"],
            "additionalProperties": False,
        },
    },
