...
Work mirror: `/org/platform/scripts/bin/url_tool`

## Usage

```bash
url_tool ticket <TICKET_ID>          # auto-detect system by prefix
url_tool ticket WORK-11909           # → [WORK-11909](https://jira.example.com/browse/WORK-11909)
url_tool smax <REQUEST_ID>           # SMAX request link
url_tool comment <TICKET_ID> <CID>   # Jira comment deep link
url_tool --plain ticket WORK-11909   # bare URL (no markdown)
```
...
WORK-, BIT-, BIN-, CAR-, CAOD-, DMOS-, DBR-, DMDAS-, HRD-, MFIT-, BISUP-, STAT-, IPAP-, ITEA-, MD-, MADP-, ADS-, BURS-, and SMAX numeric IDs.
